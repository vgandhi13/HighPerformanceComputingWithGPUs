...
int main(int argc, char **argv) {
    const int b_x = 2, b_y = 3, b_z = 4;// grid dimension - number of blocks 24
    const int t_x = 4, t_y = 4, t_z = 4; // block dimension - number of threads in each dimension - 64 threads per block
